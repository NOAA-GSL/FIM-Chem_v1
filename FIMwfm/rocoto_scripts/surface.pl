...
#$thisDir = "/home/rtfim/surface_verif/";
#$thisDir = "/scratch2/portfolios/BMC/fim/FIMRETRO_r4780/FIMwfm/rocoto_scripts/";   
chdir ("$thisDir") ||
...
if($qsubbed == 1) {
    my $output_file = "$WFMDir/log/raob/$data_source.ret_dvr.out.$output_id";
...
my $db_name = "madis3";
my $tmp_file = "$WFMDir/log/raob/${data_source}.$$.tmp";
my $data_file = "$WFMDir/log/raob/${data_source}.$$.data";
my $data_1f_file = "$WFMDir/log/raob/${data_source}.$$.data_1f";
my $coastal_file = "$WFMDir/log/raob/${data_source}.$$.coastal";
my $coastal_station_file = "$WFMDir/log/raob/${data_source}.$$.coastal_stations";
...
#FIMrun_jet_p/fim_8_64_240_201404140000/post_C/fim/NAT/grib2/1414000000006
#    my $dir = sprintf("$data_source/FIMrun_jet_p/fim_8_64_240_%4d%2.2d%2.2d%2.2d/post_C/fim/NAT/grib2",
    my $dir = sprintf("$FIM_RUN/%4d%2.2d%2.2d%2.2d/post_C/fim/NAT/grib2",
                    $year+1900,$month+1,$mday,$hour);
...
#$base_file = sprintf("%02d%03d%02d%02d%02d%02d",$year+1900-2000,$yday+1,$hour,0,0,$fcst_len);
$base_file = sprintf("%02d%03d%02d%02d%02d%02d",$year+1900-2000,$yday+1,$hour,0,0,$fcst_len);
...
sub already_processed {
    ...
    my $query =<<"EOI"
select count(*) from surface_sums.${data_source}_metar_v2_${region}
