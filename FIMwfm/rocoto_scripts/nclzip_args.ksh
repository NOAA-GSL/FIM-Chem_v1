...
##
##    ./nclzip_args.ksh /pan2/projects/fim-njet/FIM/FIMrun_jet_p ncl|ncldiff  yyyymmddhh
##
##   J. Henderson    03/24/2014

# check for correct number of parameters
if [ $# -lt 3 ]; then
  echo "Usage:  $0 /pan2/projects/fim-njet/FIM/FIMrun_jet_p ncl|ncldiff  yyyymmddhh"
  exit 1
fi

# initialize
GRID_NAMES=fimD174D201D130D244D83D129D236
MEMBER_ID=C
FIM_RUN=$1
NCLDIR=$2
yyyymmddhh=$3
