...
class TmTrkN0p125(MFbase):
    ...
    def __init__(self,
        ...
        if(modOpt == 'fim9'):
            ...
            self.fimRun='FIM9'
            self.fimRunW2flds='FIM9.%s.w2flds'%(revision)
            self.fimNameW2flds='fim9h'
            self.modelW2='fim9h'
            
            self.sdirBase='/home/rtfim'
            self.sdir="%s/%s/FIMrun_jet_p/%s"%(self.sdirBase,self.fimRun,self.dtg)
            ...
            self.fimRun='FIM'
            self.fimRunW2flds='FIM8.%s.w2flds'%(revision)
...
index ^%s
undef 9.999E+20
title /home/rtfim/FIM9ZEUS/FIMrun_jet_p/2015050412/post_C/174/NAT/grib2/FIM9.r4975.w2flds.1512412000006.grb2
...
class TmtrkCmdLine(CmdLine):
    ...
    def __init__(self,argv=sys.argv):
        ...
        self.options={
            ...
            'revision':         ['r:','r5777','a','for fim8 default|[fim9]'],
...
for dtg in dtgs:
    ...
    tmT=TmTrkN0p125(dtg,modOpt,revision=revision,override=override)
    if(verb): tmT.ls()
    if(tmT.datathere == 0): 
