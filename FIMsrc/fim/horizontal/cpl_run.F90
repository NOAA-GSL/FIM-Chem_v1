...
!TBH:  intent(out) *or* intent(inout) ...  
        ...
        hf2d(ipn)	= -gfs_HFLX  (ipn,1)	! pos down
        qf2d(ipn)	= -gfs_EVAP  (ipn,1)	! pos down
...
! 2 identical ways to get rsds/rlds
        ...
        rsus(ipn)	= -gfs_SFCUSW(ipn,1)	! sfc   upward SW, pos down
        rlus(ipn)	= -gfs_SFCULW(ipn,1)	! sfc   upward LW, pos down
        rsdt(ipn)	=  gfs_TOPDSW(ipn,1)	! top downward SW, pos down
        rsut(ipn)	= -gfs_TOPUSW(ipn,1)	! top   upward SW, pos down
        rlut(ipn)	= -gfs_TOPULW(ipn,1)	! top   upward LW, pos down
