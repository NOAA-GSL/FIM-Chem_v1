...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    use module_sfc_variables, only: rn2d, sn2d, rc2d, rn2d0, rc2d0, rg2d0, u10m, v10m,		&
      sst_prev, sst_next, fice2d_prev, fice2d_next, fice2d, rn2d6_0, rc2d6_0, rg2d6_0
    ...
    read (unitno, err=90) rn2d0, rc2d0, rg2d0, u10m, v10m, rn2d6_0, rc2d6_0, rg2d6_0
    read (unitno, err=90) sst_prev, sst_next, fice2d_prev, fice2d_next, fice2d, next_date, have_next_sst
    read (unitno, err=90) rarea, rsideln, corio, deg_lat, deg_lon, rn2d, sn2d, pw2d, rc2d
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    write (unitno, err=90) rn2d0, rc2d0, rg2d0, u10m, v10m, rn2d6_0, rc2d6_0, rg2d6_0
    write (unitno, err=90) sst_prev, sst_next, fice2d_prev, fice2d_next, fice2d, next_date, have_next_sst
    write (unitno, err=90) rarea, rsideln, corio, deg_lat, deg_lon, rn2d, sn2d, pw2d, rc2d
