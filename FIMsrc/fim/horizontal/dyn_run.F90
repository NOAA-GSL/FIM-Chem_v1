module module_fim_dyn_run
  ...
  use module_variables,only: u_tdcy,v_tdcy,dp_tdcy,dpl_tdcy,               &
                             ...
                             ws3d,sdot,rh3d,pw2d,pq2d,relvor,psrf,ptdcy,worka,  &
                             curr_write_time,wt_int_rev,k_int_rev
  ...
  use module_sfc_variables   ,only: aod2d,rn2d,sn2d,rc2d,ts2d,us2d,st3d,             &
  ...
  use module_chem_variables  ,only: p10,pm25,trfall,tr1_tavg,emi_d1,emi_d2,emi_d3,emi_d4,emi_d5,&
                                    ero1,ero2,ero3,emid1_ave,emid2_ave,emid3_ave,emid4_ave,emid5_ave,&
                                    d1st_ave,d2st_ave,d3st_ave,d4st_ave,d5st_ave,aod2d_ave,&
...
!sms$compare_var(ph3d, "dyn_run before hystat - ph3d5 ")
      ...
      if( mod(itsm1,TestDiagNoise)==0 .or. itsm1==itsStart .or. &
        ...
        call diagnoise (itsm1,ptdcy) ! sfc.pres.tendency at 2 consec. time levels
      end if
...
! if done like this it should be separated into wrfphys and chem
    if (chem_opt > 0) then ! output chem variables
      call chem_output(itsm1,nts,aod2d,exch,p10,pm25,emi_d1,emi_d2,emi_d3,emi_d4,emi_d5,ero1,ero2,ero3,pr3d,ph3d,tk3d,tr3d,trfall,&
...
100       format ('Global precip, last',i3,'h =',es14.7,' at ',f5.1,1x,a,', time step=',i8)
        ...
        do t=1,ntrb
          write (6,'(a,i3.3,a,es15.7,a,i12)') 'Tracer B',t,        &
