...
subroutine wrfphys_alloc
  ...
  gd_cloud2 = 0.
  ALLOCATE(  gd_cldfr( ims:ime , kms:kme , jms:jme ))
  gd_cldfr = 0.
  ...
  rqvften = 0.
  ALLOCATE( rucuten( ims:ime , kms:kme , jms:jme ) )
  rucuten = 0.
  ALLOCATE( rvcuten( ims:ime , kms:kme , jms:jme ) )
  rvcuten = 0.
  ...
  ALLOCATE( swcf( ims:ime , jms:jme ) )
  ALLOCATE( glw( ims:ime , jms:jme ) )
  ALLOCATE( lwcf( ims:ime , jms:jme ) )
  ...
  ALLOCATE( alb_uvb( ims:ime , jms:jme ) )
  ALLOCATE( alb_uvd( ims:ime , jms:jme ) )
  ALLOCATE( alb_irb( ims:ime , jms:jme ) )
  ALLOCATE( alb_ird( ims:ime , jms:jme ) )
  ALLOCATE( sfc_emiss( ims:ime , jms:jme ) )
