     ...
     &      yyyymmddhhmm,sscal,asymp,ext_cof,
     &      extlw_cof,cldcov_v)
!!
!
...
! - for couplimg with chemistry (FIM-CHem)
      real(kind=kind_rad) :: sscal(levs,14)
      real(kind=kind_rad) :: ext_cof(levs,14)
      real(kind=kind_rad) :: asymp(levs,14)
      real(kind=kind_rad) :: extlw_cof(levs,16)
