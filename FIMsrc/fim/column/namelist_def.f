     ...
     &,       levwgt(2),k2o
      real(kind=kind_evod) fhrot,fhseg,fhmax,fhout,fhres
     &,                    fhzer,fhini,fhdfi,fhcyc,filta,crtrh(3)
     &,                    flgmin(2),ref_temp,ccwf(2),dlqf(2)
...
! jbao 2014 update
      parameter (ngptc = 1, gen_coord_hybrid=.false.)
! jbao 2014 update
