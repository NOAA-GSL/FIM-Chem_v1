Module module_gocartracm_pointers
USE module_initial_chem_namelists,only:p_so2,p_sulf,p_no2,p_no,p_o3, &
       ...
       p_hket,p_api,p_lim,p_dien,p_macr,p_ho,p_ho2,p_dms,p_msa,      &
...
! anthropogenic emissions
       ...
       p_e_hc8,p_e_xyl,p_e_olt,p_e_oli,p_e_tol,p_e_csl,              &
...
END MODULE module_gocartracm_pointers
