MODULE MODULE_GOCART_CHEM
    USE module_initial_chem_namelists,only: p_o3,p_qi,p_qc,p_qv,p_dms,p_so2,        &
                                  p_sulf,p_msa,p_ho,p_h2o2,p_no3
!   USE module_constants,only: pi,rd,g
CONTAINS

  subroutine gocart_chem_driver(ktau,dtlt,dt,gmt,julday,t_phy,moist,  &
...
!  TYPE(grid_config_rec_type),  INTENT(IN   )    :: config_flags
  ...
  real:: rlat,xlonn
      real :: xtime,zenith,zenita,azimuth,xhour,xmin,xtimin,gmtp
      INTEGER :: ixhour
       imx=1
       jmx=1
       lmx=1
